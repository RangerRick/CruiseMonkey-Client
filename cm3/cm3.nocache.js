function cm3(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_49, $intern_56, $intern_64], $intern_78 + $intern_73);
      unflattenKeylistIntoAnswers([$intern_49, $intern_55, $intern_64], $intern_78 + $intern_73);
