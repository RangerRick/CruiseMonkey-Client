function cm3(){
  ...
  if (!isHostedMode()) {
    try {
      unflattenKeylistIntoAnswers(['no', 'y', 'safari'], '20FE25F6C4DB245D4BF93738E2708ECF');
      unflattenKeylistIntoAnswers(['no', 'n', 'ie6'], '3D75048F7A0CE2BFB1CA4823942F8402');
      unflattenKeylistIntoAnswers(['no', 'y', 'ie6'], '3D75048F7A0CE2BFB1CA4823942F8402');
      unflattenKeylistIntoAnswers(['no', 'n', 'ie6'], '3D75048F7A0CE2BFB1CA4823942F8402' + ':1');
      unflattenKeylistIntoAnswers(['no', 'y', 'ie6'], '3D75048F7A0CE2BFB1CA4823942F8402' + ':1');
      unflattenKeylistIntoAnswers(['no', 'n', 'ie9'], '5A56D1773D7310EC58D75EBBBA518C6D');
      unflattenKeylistIntoAnswers(['no', 'y', 'ie9'], '5A56D1773D7310EC58D75EBBBA518C6D');
      unflattenKeylistIntoAnswers(['no', 'n', 'ie9'], '5A56D1773D7310EC58D75EBBBA518C6D' + ':1');
      unflattenKeylistIntoAnswers(['no', 'y', 'ie9'], '5A56D1773D7310EC58D75EBBBA518C6D' + ':1');
      unflattenKeylistIntoAnswers(['no', 'n', 'safari'], '8A4952F76A7F5316BB5A785B64620FBC');
      unflattenKeylistIntoAnswers(['no', 'n', 'opera'], 'B66632C15DD76564F81E5ED41D731B4B');
      unflattenKeylistIntoAnswers(['no', 'y', 'opera'], 'B66632C15DD76564F81E5ED41D731B4B');
      unflattenKeylistIntoAnswers(['no', 'n', 'opera'], 'B66632C15DD76564F81E5ED41D731B4B' + ':1');
      unflattenKeylistIntoAnswers(['no', 'y', 'opera'], 'B66632C15DD76564F81E5ED41D731B4B' + ':1');
      unflattenKeylistIntoAnswers(['yes', 'n', 'safari'], 'C2DB4626B0B0BCB873BD4D259E41E978');
      unflattenKeylistIntoAnswers(['no', 'n', 'gecko1_8'], 'DE42502896290325F49A53F869018BD7');
      unflattenKeylistIntoAnswers(['no', 'y', 'gecko1_8'], 'DE42502896290325F49A53F869018BD7');
      unflattenKeylistIntoAnswers(['no', 'n', 'gecko1_8'], 'DE42502896290325F49A53F869018BD7' + ':1');
      unflattenKeylistIntoAnswers(['no', 'y', 'gecko1_8'], 'DE42502896290325F49A53F869018BD7' + ':1');
      unflattenKeylistIntoAnswers(['yes', 'y', 'safari'], 'DE6E2A6426379A97D3F6C7A655AA2FCF');
      unflattenKeylistIntoAnswers(['no', 'n', 'ie8'], 'DEDEDFA35CC5B1BA513012DD7B0A956B');
      unflattenKeylistIntoAnswers(['no', 'y', 'ie8'], 'DEDEDFA35CC5B1BA513012DD7B0A956B');
      unflattenKeylistIntoAnswers(['no', 'n', 'ie8'], 'DEDEDFA35CC5B1BA513012DD7B0A956B' + ':1');
      unflattenKeylistIntoAnswers(['no', 'y', 'ie8'], 'DEDEDFA35CC5B1BA513012DD7B0A956B' + ':1');
