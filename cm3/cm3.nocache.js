function cm3(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_49, $intern_56, $intern_58], $intern_78 + $intern_72);
      unflattenKeylistIntoAnswers([$intern_49, $intern_55, $intern_58], $intern_78 + $intern_72);
